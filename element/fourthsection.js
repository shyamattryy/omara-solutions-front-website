...
import Styles from '../scss/fourth/four.module.scss'
  ...
  return (
  <div className={`${Styles.darkcoloumn} container-fluid`} style={{padding:"55px 0px !important"}}>
    <div className={`${Styles.fourth} row container`}>
        <div className={`${Styles.creative} col-6`}>
            <div className={Styles.headingtext}>
            <h2>WE CREATE INNOVATIVE  <span className={Styles.head_bck}>PLATFORMS</span> </h2>
