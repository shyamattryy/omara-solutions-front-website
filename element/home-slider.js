                        ...
                        <div className="row">
                            ...
                            <div className="slidertextblock">
                                    ...
                                    {/* <a href="#" ><span>Button</span><i></i></a> */}
                                     <a href="/enabling-business-transformation"  target="_blank"><span>Know More</span><i></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="slidertextblock">
                                    ...
                                    <a href="/our-partner-ecosystem" target="_blank"><span>Know More</span><i></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="slidertextblock">
                                    ...
                                    <a href="/third-knowmore"  target="_blank"><span>Know More</span><i></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="slidertextblock">
                                    ...
                                    <a href="fourth-knowmore"  target="_blank"><span>Know More</span><i></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
